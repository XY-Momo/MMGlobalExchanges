 ...
 * 个人信息界面
 */
public class BlackPersonalInfo extends Chest {

    private PlayerData playerData;
    public BlackPersonalInfo(String title) {
        super(title, 54);
    }
    ...
    private void addPurchaseInfo(Player player) {
        ...
        lore.add("§f购买次数: " + playerData.getBlackBuyNumber());
    ...
    private void addSellInfo(Player player) {
        ...
        List<String> lore = itemMeta.hasLore() ? itemMeta.getLore() : new ArrayList<>();
        lore.add("§f用户: " + player.getName());
        lore.add("§f出售次数: " + playerData.getBlackSellNumber());
