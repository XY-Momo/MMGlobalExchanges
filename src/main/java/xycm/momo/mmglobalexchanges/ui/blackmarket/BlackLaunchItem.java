 ...
 * 上架物品界面
 */
public class BlackLaunchItem extends Chest {
     ...
     */
    public BlackLaunchItem(String title, int price) {
        super(title, 54);
        this.price = price;
    }
    ...
    public void returnItem(Player player) {
        ...
        this.removeItem(0);
        BlackSelectItem blackSelectItem = new BlackSelectItem(MMGlobalExchanges.instance.getConfig().getString("market.select"));
        blackSelectItem.open(player);
    }
